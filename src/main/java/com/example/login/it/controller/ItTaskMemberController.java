...
public class ItTaskMemberController {
    ...
    public ItTaskMemberController(
            ItTaskMemberService itTaskMemberService,
    ...
    public String taskList(
        ...
        List<ItTaskMember> filteredTasks =
                hasFilter
                ? itTaskMemberService.findByFilters(
                        nik,
                        factory,
                        status
                  )
        ...
        model.addAttribute(
                "nik",
                Objects.toString(nik, "")
        );

        model.addAttribute(
                "factory",
                Objects.toString(factory, "")
        );
        ...
        model.addAttribute(
                "factoryOptions",
                itTaskMemberService.findDistinctFactories()
        );

        model.addAttribute(
                "statusOptions",
                itTaskMemberService.findDistinctStatuses()
        );
